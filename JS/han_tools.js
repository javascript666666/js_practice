...
han.css = function (){
  ...
  function getStyle(attr){
    return attr == 'width' || attr == 'height' || attr == 'left' || attr == 'bottom' || attr == 'right' || attr == 'margin-left' || attr == 'marginLeft' || attr == 'margin-right' || attr == 'marginRight' || attr == 'margin-bottom' || attr == 'marginBottom' || attr == 'margin-top' || attr == 'marginTop';
  }
